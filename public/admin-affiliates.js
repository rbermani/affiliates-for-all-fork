...
function defaultCommission() {
    if($("#details_default_commission").is("[checked]")) {
        ...
        $("#details_commission_parent_percent").attr("value",
            $("#commission_parent_percent").text());
        $("#details_commission_parent_fixed").attr("value",
            $("#commission_parent_fixed").text());


        $("#details_commission_percent, #details_commission_parent_percent, #details_commission_parent_fixed, #details_commission_fixed").
            attr("disabled", true);
    } else {
        $("#details_commission_percent, #details_commission_parent_percent, #details_commission_parent_fixed, #details_commission_fixed").
            attr("disabled", false);
